...
echo "Generating ECC Certificate for $CLIENT_NAME..."
# 1. Tạo Client Certificate
cd $PKI_DIR
...
echo -e "extendedKeyUsage=clientAuth\nkeyUsage=digitalSignature,keyAgreement" > ${CLIENT_NAME}_ext.cnf

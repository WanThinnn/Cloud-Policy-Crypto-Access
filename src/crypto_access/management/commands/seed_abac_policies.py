    ...
    def handle(self, *args, **options):
        ...
        policies = [
            ...
            },
            {
                ...
                'subject_condition': "r.sub.department == 'hr' and r.sub.role in ['manager', 'director']",
                'resource': 'document',
                'action': 'upload',
                'effect': 'allow',
                'priority': 35,
            ...
            # Finance Department access
            {
                ...
                'cpabe_policy': "(department:finance and (clearance_level:secret or clearance_level:top_secret))",
                'resource': 'document',
                'action': 'read',
                'effect': 'allow',
                'priority': 40,
            ...
            # Auditor access
            {
                ...
                'cpabe_policy': "user_type:auditor",
                'resource': 'document',
                'action': 'read',
                'effect': 'allow',
                'priority': 25,
        ...
        for policy_data in policies:
            policy, created = AccessPolicy.objects.update_or_create(
                ...
                defaults={
                    ...
                    'cpabe_policy': policy_data.get('cpabe_policy', None),
                    'is_active': True,
                    'created_by': admin,
                }
            )

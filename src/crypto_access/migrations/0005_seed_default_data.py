...
def seed_user_types(apps, schema_editor):
    ...
    user_types = [
        ...
        },
        {
            ...
            'description': 'Người đóng góp dữ liệu - Được phép tải file, tạo chính sách, mã hóa và xem/tải các file khác',
        ...
        },
        {
            'code': 'data_viewer',
            'name': 'Data Viewer',
            'description': 'Người xem dữ liệu - Chỉ có quyền đọc và tải file theo chính sách được cấp',

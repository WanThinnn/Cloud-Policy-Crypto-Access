...
```bash
PUT /api/super-admin/users/{user_id}/attributes
Authorization: Bearer <admin-token>
Content-Type: application/json
...
```bash
# Deactivate user
POST /api/super-admin/users/{user_id}/deactivate
Authorization: Bearer <admin-token>

# Activate user
POST /api/super-admin/users/{user_id}/activate
Authorization: Bearer <admin-token>
```
...
file: <file-data>
access_policy: "role:manager AND department:it"
metadata: {"description": "Confidential report"}
```
...
```bash
POST /api/ca/users/{user_id}/private-key
Authorization: Bearer <admin-token>
```
...
```bash
GET /api/ca/user/private-key/check
Authorization: Bearer <user-token>
```
...
```bash
POST /api/ca/user/private-key/generate
Authorization: Bearer <user-token>
```
...
```bash
DELETE /api/abac/policies/{policy_id}
Authorization: Bearer <admin-token>
```
...
```bash
POST /api/abac/setup-corporate-policies
Authorization: Bearer <admin-token>
```
